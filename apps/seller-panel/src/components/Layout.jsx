...
import { LayoutDashboard, FolderTree, Package, Image as ImageIcon, User, Settings, LogOut, Store } from 'lucide-react';
...
export const Layout = () => {
  ...
  const navItems = [
    ...
    { to: '/products/images', label: 'Product Images', icon: ImageIcon },
        ...
        <div className="p-4 border-t border-slate-800">
          <div className="flex items-center justify-between p-2 rounded-lg bg-slate-950/50 border border-slate-800/80">
            <div className="truncate pr-2">
              <p className="text-xs font-semibold text-slate-200 truncate">{user?.firstName || user?.ownerName || 'Seller'} {user?.lastName || ''}</p>
